...
export interface ApiCollectionCollection extends Schema.CollectionType {
  ...
  attributes: {
    ...
    storeProductId: Attribute.BigInteger;
...
export interface ApiCollectionItemCollectionItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    claimZone: Attribute.Enumeration<
      [
        'Scosglen',
        'Dry Steppes',
        'Fractured Peaks',
    ...
    >;
    claimMonster: Attribute.Enumeration<
      [
        'Treasure Goblins',
        'Uber Lilith',
        'Ashava',
    ...
    promotional: Attribute.Boolean;
    season: Attribute.Integer;
    name: Attribute.String;
